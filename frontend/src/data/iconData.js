...
export const PROFILE_ICONS = {
  ...
  people: [
    ...
    { emoji: "🕴", name: "person in suit levitating" },
  ...
  travel: [
    ...
    { emoji: "⏲", name: "timer clock" },
    { emoji: "🕰", name: "mantelpiece clock" },
    ...
    { emoji: "⛈", name: "cloud with lightning and rain" },
    { emoji: "🌤", name: "sun behind small cloud" },
    { emoji: "🌥", name: "sun behind large cloud" },
    { emoji: "🌦", name: "sun behind rain cloud" },
    { emoji: "🌧", name: "cloud with rain" },
  ...
  objects: [
    ...
    { emoji: "🎞", name: "film frames" },
    { emoji: "📽", name: "film projector" },
    ...
    { emoji: "🗞", name: "rolled-up newspaper" },
    ...
    { emoji: "✏", name: "pencil" },
    { emoji: "✒", name: "black nib" },
    { emoji: "🖋", name: "fountain pen" },
    { emoji: "🖊", name: "pen" },
    ...
    { emoji: "🗒", name: "spiral notepad" },
    { emoji: "🗓", name: "spiral calendar" },
    ...
    { emoji: "🪓", name: "axe" },
    { emoji: "⛏", name: "pick" },
    { emoji: "⚒", name: "hammer and pick" },
    { emoji: "🛠", name: "hammer and wrench" },
    { emoji: "🗡", name: "dagger" },
    { emoji: "⚔", name: "crossed swords" },
    { emoji: "💣", name: "bomb" },
  ...
  symbols: [
    ...
    { emoji: "↘", name: "down-right arrow" },
    { emoji: "⬇", name: "down arrow" },
    { emoji: "↙", name: "down-left arrow" },
    { emoji: "⬅", name: "left arrow" },
    { emoji: "↖", name: "up-left arrow" },
    { emoji: "↕", name: "up-down arrow" },
    { emoji: "↔", name: "left-right arrow" },
    { emoji: "↩", name: "right arrow curving left" },
    { emoji: "↪", name: "left arrow curving right" },
    { emoji: "⤴", name: "right arrow curving up" },
    { emoji: "⤵", name: "right arrow curving down" },
    ...
    { emoji: "⚛", name: "atom symbol" },
    { emoji: "🕉", name: "om" },
    { emoji: "✡", name: "star of David" },
    { emoji: "☸", name: "wheel of dharma" },
    { emoji: "☯", name: "yin yang" },
    { emoji: "✝", name: "latin cross" },
    { emoji: "☦", name: "orthodox cross" },
    { emoji: "☪", name: "star and crescent" },
    ...
    { emoji: "♀", name: "female sign" },
    { emoji: "♂", name: "male sign" },
    ...
    { emoji: "♾", name: "infinity" },
    { emoji: "‼", name: "double exclamation mark" },
    { emoji: "⁉", name: "exclamation question mark" },
    ...
    { emoji: "⚕", name: "medical symbol" },
    { emoji: "♻", name: "recycling symbol" },
    ...
    { emoji: "🈂", name: "Japanese “service charge” button" },
    { emoji: "🈷", name: "Japanese “monthly amount” button" },
    ...
    { emoji: "㊙", name: "Japanese “secret” button" },
